...
public class ComboController implements ComboCall {


    private static final String TAG = "Controller";

    Context context;
    ComboCallBack callback2;


    public ComboController(Context context, ComboCallBack callback2) {
